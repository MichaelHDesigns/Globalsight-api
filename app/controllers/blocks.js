    ...
    if (err) {
      ...
      async.mapSeries(blockList,
        function(b, cb) {
	      ...
	      bits: info.bits,
	      auxpow: info.auxpow,  
	      auxpow_isstake: info.auxpow.auxpow_isstake,
              auxpow_isequish: info.auxpow.auxpow_isequish,
              auxpow_iszhash: info.auxpow.auxpow_iszhash,
	      auxpow_powhash: info.auxpow.powhash,   
              auxpow_rawversion: info.auxpow.rawversion,
