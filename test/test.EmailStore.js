...
describe('emailstore test', function() {
  ...
  describe('database queries', function() {
    ...
    describe('exists', function() {
      ...
      var fakeEmailKey = 'email-to-passphrase-' + Globaltokencore.util.twoSha256(fakeEmail).toString('hex');
    ...
    describe('saving encrypted data', function() {
      ...
      var expectedKey = 'emailstore-' + Globaltokencore.util.twoSha256(fakeEmail + '#' + fakeKey).toString('hex');
