...
describe('Rates service', function() {
  ...
  describe('#getRate', function() {
    ...
    it('should get rate with exact ts', function(done) {
      db.batch([{
        type: 'put',
        key: 'globaltoken-USD-10',
        value: 123.45
      }, ]);
      rates._getRate('globaltoken', 'USD', 10, function(err, res) {
    ...
    it('should get rate with approximate ts', function(done) {
      db.batch([{
        ...
        type: 'put',
        key: 'globaltoken-USD-20',
        value: 200.00,
      }]);
      rates._getRate('globaltoken', 'USD', 25, function(err, res) {
    ...
    it('should get rate from specified source', function(done) {
      ...
      rates._getRate('globaltoken', 'USD', 12, function(err, res) {
        res.rate.should.equal(123.45);
        done();
      });
    });
    it('should get rate for specified currency', function(done) {
      db.batch([{
        ...
        type: 'put',
        key: 'globaltoken-EUR-10',
        value: 200.00,
      }]);
      rates._getRate('globaltoken', 'EUR', 12, function(err, res) {
        res.rate.should.equal(200.00);
        done();
      });
    });
    it('should get multiple rates', function(done) {
      ...
      rates._getRate('globaltoken', 'USD', [10, 20, 35], function(err, res) {
        expect(err).to.not.exist;
